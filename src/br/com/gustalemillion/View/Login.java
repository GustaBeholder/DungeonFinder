...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(550, 211));
    ...
    private void botaoEntrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoEntrarActionPerformed
        ...
        Jogador jogador = jogadorDAO.validaLogin(EmailText.getText());

        if(jogador.getEmail() == null){
          JOptionPane.showMessageDialog(this, "Email inválido.", "Validação", JOptionPane.INFORMATION_MESSAGE);
          reiniciaTela();  
        }
        else{
            JogadorAtual.setJogador(jogador);
            Main next = new Main();;
